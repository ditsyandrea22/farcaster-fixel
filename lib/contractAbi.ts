/**
 * Complete NFT Contract ABI (Proxy Pattern)
 * Based on OpenZeppelin UUPS Proxy
 */
...
export const NFT_ABI = [
  ...
  { anonymous: false, inputs: [{ indexed: false, internalType: "uint256", name: "tokenId", type: "uint256" }], name: "MetadataUpdate", type: "event" },
  ...
  { inputs: [], name: "placeholderURI", outputs: [{ internalType: "string", name: "", type: "string" }], stateMutability: "view", type: "function" },
