...
const NFT_CONTRACT = process.env.NEXT_PUBLIC_NFT_CONTRACT_ADDRESS || '0x5717EEFadDEACE4DbB7e7189C860A88b4D9978cF'
    ...
    const frameHtml = `
      ...
      <html>
        <head>
          ...
          <meta name="twitter:image" content="${MINI_APP_URL}/og-image.png" />
        </head>
        <body></body>
      </html>
    `
    ...
    const errorHtml = `
      ...
      <html>
        <head>
          ...
          <meta property="fc:frame" content="vNext" />
          <meta property="fc:frame:image" content="${MINI_APP_URL}/error-image.png" />
